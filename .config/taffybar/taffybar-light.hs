...
expertLog = do
    ...
    -- Haskell logo
    pixbuf <- pixbufNewFromFileAtScale "/home/suwako/.xmonad/icons/Haskell-logo-black.svg" (-1) 12 True
...
expertClock = do
    clock <- textClockNew Nothing "<span font='Terminus 8' fgcolor='#101010'>%a %b %_d, %H:%M:%S</span>" 1
    return clock
