...
#
# History:
# 2012-10-13, Shou <gnusokyo@gmail.com>
...
rs = {
    ...
    "#omggz": "ヾ(●ﾟワﾟ●)ﾉ゛",
    "#hi5": "(　｀ー´)八(｀ー´　) ＨＩ５",
    "#hi": "(　｀ー´)ﾉ DON'T LEAVE ME HANGING BRO",
    "#5": "ヽ(｀ー´　) ＨＩ５",
    "#kuu1": "(/ω＼)",
    "#durr": "（ ｡∀ﾟ ）",
    "#kuu2": "(＞人＜;)",
    ...
    "#sleep": "(。-ω-)zzz. . .",
    "#oyasumi": "(。-ω-)zzz おやすみ. . .",
    "#wizard": "11゜・。13。・゜9゜・。。・゜7☆ヽ(｀ー´)ﾉ 7ｱﾊﾊ9八八ﾉヽ13ﾉヽﾉヽﾉ ＼11 / ＼/ ＼",
    "#proud": "(▰˘◡˘▰)",
    "#kuma": "ʕ•ᴥ•ʔ",
    "#:c": "( ﾟ∩ﾟ)",
    "#aaaa": "휴Д휴",
...
def command_run_input(data, buffer, command):
    ...
    if command == "/input return": # As in enter was pressed.
        ...
        elif not re.match("^(https?://|>|/(?!/|stutter|msg))", input_s, re.I):
            for r in rs:
